...
const OnDestinationScreen: React.FC = () => {
  ...
  const renderRecentItem = ({ item }: { item: Location }) => (
    <TouchableOpacity style={styles.locationItem}>
      <View>
        ...
        <SVGS.historyPick width={28} height={28} />
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Animated.View
        style={[styles.locationContainer, { height: containerHeight }]}
      ...
      <View style={styles.footer}>
        <View style={styles.footerButton}>
          ...
          <TouchableOpacity onPress={showModal}>
            <SVGS.addCircle width={20} height={20} />
          </TouchableOpacity>
        </View>
        ...
        <ButtonF
          ...
          size="secondary"
          radius="mini"
          onPress={() => router.push("/booking/choiceCar/selectCar")}
        />
      </View>
