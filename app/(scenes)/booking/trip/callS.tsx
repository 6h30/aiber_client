    ...
    <View style={styles.container}>
      ...
      <View style={styles.callContainer}>
        <View style={styles.driverInfo}>
          <SVGS.personCircle width={34} height={34} />
        ...
        {callActive ? (
          <View style={styles.actionButtons}>
            ...
            >
              <SVGS.headPhone width={24} height={24} />
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.actionButton,
            ...
            >
              <SVGS.cameraOff width={24} height={24} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.endButton} onPress={handleEndCall}>
              <SVGS.deleteCircle width={34} height={34} />
            </TouchableOpacity>
          </View>
        ) : (
          <TouchableOpacity
          ...
          >
            <SVGS.phoneCall width={34} height={34} />
          </TouchableOpacity>
        )}
      </View>
    </View>
